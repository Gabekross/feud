...
export const FULL_RULES_SLIDES: RulesSlide[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'In later rounds, the host may double or triple finalized round points.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Later rounds may count for double or triple points when the host calls for it.',
      'If no family reaches the target after regular rounds, play the Tie Breaker Round.',
      'In the Tie Breaker, one final survey question decides who wins the game.',
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      'The first family to give the top answer wins the Tie Breaker.',
...
export const QUICK_RULES_SLIDES: RulesSlide[] = [
  {
    ...
    bullets: [
      ...
      'Later rounds can use double or triple points.',
      'Reach 300 points to win.',
      'If nobody reaches the target, the Tie Breaker decides the winner.',
